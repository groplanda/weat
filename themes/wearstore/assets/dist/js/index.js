...
/***/ "./themes/wearstore/assets/src/js/index.js":
/*!*************************************************!*\
  !*** ./themes/wearstore/assets/src/js/index.js ***!
  \*************************************************/
/*! no exports provided */
...
/* harmony import */ var _module_Product__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/Product */ "./themes/wearstore/assets/src/js/module/Product.js");
/* harmony import */ var _module_Modals__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/Modals */ "./themes/wearstore/assets/src/js/module/Modals.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _module_Cart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./module/Cart */ "./themes/wearstore/assets/src/js/module/Cart.js");
/* harmony import */ var _module_Tabs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./module/Tabs */ "./themes/wearstore/assets/src/js/module/Tabs.js");
/* harmony import */ var nouislider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! nouislider */ "./node_modules/nouislider/distribute/nouislider.js");
/* harmony import */ var nouislider__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(nouislider__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _module_wNumb_min_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./module/wNumb.min.js */ "./themes/wearstore/assets/src/js/module/wNumb.min.js");
/* harmony import */ var _module_wNumb_min_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_module_wNumb_min_js__WEBPACK_IMPORTED_MODULE_8__);
...
var openCart = document.getElementById('open-cart'),
    ...
    sortValues = [document.querySelector('[data-price="start"]'), document.querySelector('[data-price="end"]')],
    withUser = screen.width || document.documentElement.clientWidth;
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]);
Object(_module_Product__WEBPACK_IMPORTED_MODULE_2__["default"])('.product');
Object(_module_Modals__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_module_Cart__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_module_Tabs__WEBPACK_IMPORTED_MODULE_6__["Tabs"])('.product__tabs-header-item');
...
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-featured', {
  slidesPerView: 4,
  slidesPerColumn: 0,
  spaceBetween: 30,
  pagination: {
...
openCart.addEventListener('click', function (e) {
  return openNextDropdown(e, openCart);
});
openSearch.addEventListener('click', function (e) {
  return openNextDropdown(e, openSearch);
});
...
if (questions) {
  questions.forEach(function (question) {
    question.addEventListener('click', function () {
      ...
      var body = question.nextElementSibling,
...
jquery__WEBPACK_IMPORTED_MODULE_4___default()('.products').on('click', '.pagination > ul > li > a.click-page', productFilter);
...
if (colorFilter) {
  colorFilter.addEventListener('click', function (e) {
    return openNextDropdown(e, colorFilter);
  });
}

if (sizeFilter) {
  sizeFilter.addEventListener('click', function (e) {
    return openNextDropdown(e, sizeFilter);
  });
}

if (sortFilter) {
  sortFilter.addEventListener('click', function (e) {
    return openNextDropdown(e, sortFilter);
  });
...
function createRange() {
  var maxPrice = sortPrice.dataset.max,
      minPrice = sortPrice.dataset.min;
  nouislider__WEBPACK_IMPORTED_MODULE_7___default.a.create(sortPrice, {
    ...
    format: _module_wNumb_min_js__WEBPACK_IMPORTED_MODULE_8___default()({
      decimals: 0,
      thousand: ''
    })
  });
...
function productFilter(e) {
  e.preventDefault();
  var page = document.querySelector('.click-page.active');
  ...
  var colors = [];
  var sizes = [];
  var sort = 'sort_order asc';
  var min = sortValues[0].textContent;
  var max = sortValues[1].textContent;
  sortRadio.forEach(function (radio) {
    radio.checked ? sort = radio.value : '';
  });
  colorCheckboxes.forEach(function (color) {
    color.checked ? colors.push(color.value) : '';
  });
  sizeCheckboxes.forEach(function (size) {
    size.checked ? sizes.push(size.value) : '';
  });
  var products = document.querySelector('.products__wrapper'),
      filters = document.querySelectorAll('.products__filter-selectbox-title');
  jquery__WEBPACK_IMPORTED_MODULE_4___default.a.request('onFilterProduct', {
...
jquery__WEBPACK_IMPORTED_MODULE_4___default()('.theme__form').on('ajaxSuccess', function (event) {
...
/***/ "./themes/wearstore/assets/src/js/module/Cart.js":
/*!*******************************************************!*\
  !*** ./themes/wearstore/assets/src/js/module/Cart.js ***!
  \*******************************************************/
/*! exports provided: default */
...
var Cart = function Cart() {
  var sidebarCart = document.querySelector('[data-cart="big-cart"]'),
  ...
  if (updateCart) {
    updateCart.addEventListener('submit', function (e) {
      e.preventDefault();
      var inputs = this.getElementsByClassName('qty'),
          products = JSON.parse(localStorage.getItem('products')) || [],
          newProduct = Array.from(inputs).map(function (input) {
        var prefix = input.dataset;
        return {
          id: prefix.id,
          slug: prefix.slug,
          title: prefix.title,
      ...
      newProduct.forEach(function (elem) {
  ...
  function successMessage() {
    var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Товар успешно добавлен!';
    var alertClass = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'success';
    var html = "<div class=\"alert-message\">\n                        <div class=\"alert alert-".concat(alertClass, "\" data-interval=\"4\">").concat(text, "</div>\n                    </div>");
  ...
  if (addToCart) {
    addToCart.addEventListener('submit', function (e) {
      e.preventDefault();
      var prefix = addToCart.qty.dataset;
  ...
  document.addEventListener('click', handleClick); //обработка событий для покупки нового товара и его удаления

  function handleClick(e) {
    var target = e.target;

    if (target.classList.contains('add-to-cart') && target.tagName.toLowerCase() == 'button' || target.parentNode.classList.contains('add-to-cart') && target.parentNode.tagName.toLowerCase() == 'button') {
      e.preventDefault();
      addProductToCart(e);
      callMethods();
      successMessage();
  ...
  function fillCart(position) {
    if (position) {
      var productWrap = position.querySelector('[data-items="product"]'),
          products = JSON.parse(localStorage.getItem('products')) || [],
          buttons = position.querySelector('[data-buttons="true"]'),
          _totalSum = position.querySelector('[data-sum="total"');

      if (productWrap) {
        productWrap.innerHTML = '';
        products.length > 0 ? pushCart(productWrap, _totalSum, buttons, products, 'standart') : hideFooterCart(_totalSum, buttons, productWrap, '<div>Корзина пуста!</div>');
      } else if (productWrap = position.querySelector('[data-items="table"]')) {
        productWrap.innerHTML = '';
        products.length > 0 ? pushCart(productWrap, _totalSum, buttons, products, 'cart') : hideFooterCart(_totalSum, buttons, productWrap, '<tr class="cart-item"><td colspan="6">Корзина пуста!</td></tr>');
      } else if (productWrap = position.querySelector('[data-items="checkout"]')) {
        productWrap.innerHTML = '';
        products.length > 0 ? pushCart(productWrap, _totalSum, buttons, products, 'checkout') : hideFooterCart(_totalSum, buttons, productWrap, '<tr class="cart-item"><td colspan="2">Вы ничего не добавили в корзину!</td></tr>');
        products.length > 0 ? document.querySelector('[data-button="checkout"]').removeAttribute('disabled') : document.querySelector('[data-button="checkout"]').setAttribute('disabled', true);
      }
    }
  } //заполнение корзины
  ...
  function generateHtml() {
    ...
    var type = props[0],
        products = props[1]; //spread

    var html = '';

    if (type == 'standart') {
      html = products.map(function (product) {
        return "<li class=\"cart-item\">\n                            <div class=\"cart-item__pic\">\n                                <a href=\"/product/".concat(product.slug, "\" title=\"").concat(product.title, "\">\n                                    <img class=\"cart-item__thumb\" src=\"").concat(product.image, "\" alt=\"").concat(product.title, "\">\n                                </a>\n                            </div>\n                            <div class=\"cart-item__info\">\n                                <h6 class=\"cart-item__title\">").concat(product.title, "</h6>\n                                <span class=\"cart-item__price\">").concat(product.price, " \u20BD</span>\n                                <span class=\"cart-item__qty\">\u041A\u043E\u043B-\u0432\u043E: ").concat(product.count, "</span>\n                            </div>\n                        </li>");
      }).join(' ');
    } else if (type == 'cart') {
      html = products.map(function (product) {
        return "<tr>\n                            <td class=\"image\">\n                                <div class=\"image__pic\">\n                                    <a href=\"/product/".concat(product.slug, "\" title=\"").concat(product.title, "\">\n                                        <img class=\"image__thumb\" src=\"").concat(product.image, "\" alt=\"").concat(product.title, "\" />\n                                        <span class=\"image__title\">").concat(product.title, "</span>\n                                    </a>\n                                </div>\n                            </td>\n                            <td><span class=\"price\">").concat(product.price, "\u20BD</span></td>\n                            <td>\n                                <div class=\"quantity\">\n                                    <button type=\"button\" class=\"quantity-left-minus\"  data-type=\"minus\" data-field=\"\"><i class=\"fas fa-minus\"></i></button>\n                                        <input\n                                            type=\"number\"\n                                            id=\"quantity\"\n                                            class=\"quantity__input qty\"\n                                            name=\"qty\"\n                                            min=\"1\"\n                                            max=\"100\"\n                                            step=\"1\"\n                                            value=\"").concat(product.count, "\"\n                                            data-price=\"").concat(product.price, "\"\n                                            data-image=\"").concat(product.image, "\"\n                                            data-title=\"").concat(product.title, "\"\n                                            data-id=\"").concat(product.id, "\"\n                                        />\n                                    <button type=\"button\" class=\"quantity-right-plus\" data-type=\"plus\" data-field=\"\"><i class=\"fas fa-plus\"></i></button>\n                                </div>\n                            </div>\n                            </td>\n                            <td><span class=\"price\">").concat(Number(product.price) * Number(product.count), "\u20BD</span></td>\n                            <td><i class=\"far fa-trash-alt remove\" data-id=\"").concat(product.id, "\" data-cart=\"add\"></i></td>\n                        </tr>");
      }).join(' ');
    } else if (type == 'checkout') {
      html = products.map(function (product) {
        return "<tr>\n                            <td>".concat(product.title, "&nbsp;\n                                <strong>&times; ").concat(product.count, "</strong>\n                            </td>\n                            <td>\n                                <strong>").concat(Number(product.price) * Number(product.count), "</strong><span>\u20BD</span>\n                            </td>\n                        </tr>");
      }).join(' ');
    }
  ...
  function calculateSum(products) {
    ...
    if (products) {
      ...
      sum = products.reduce(function (sum, current) {
        return sum + current;
      });
    }
  ...
  function totalSum() {
    var sale = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    var products = JSON.parse(localStorage.getItem('products')) || [];
    var sum = 0;

    if (products.length > 0) {
      sum = products.reduce(function (sum, product) {
  ...
  function changeQty() {
    ...
    function checkQtyHanlde(target, selector) {
      var operation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'sum';

      if (target.classList.contains(selector) || target.parentNode.classList.contains(selector)) {
        var qty = target.closest('.quantity');
        var input = qty.querySelector('.quantity__input');
  ...
  if (selected) {
    var product = document.querySelector('.single-product'),
    ...
    selected.addEventListener('change', function (e) {
      ...
      if (target.value === 'null') {
        ...
        var select = target.options[target.selectedIndex],
...
/***/ "./themes/wearstore/assets/src/js/module/Modals.js":
/*!*********************************************************!*\
  !*** ./themes/wearstore/assets/src/js/module/Modals.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/***/ "./themes/wearstore/assets/src/js/module/Product.js":
/*!**********************************************************!*\
  !*** ./themes/wearstore/assets/src/js/module/Product.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var Product = function Product(productSelector) {
  try {
    // смена картинки
    var changeImage = function changeImage() {
      listImages.forEach(function (itemImage) {
        itemImage.addEventListener('click', function () {
          ...
          var src = itemImage.firstElementChild.dataset.image;
    ...
    var removeClass = function removeClass(nodeList) {
      var classSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'selected';
      nodeList.forEach(function (elem) {
        return elem.classList.remove(classSelector);
      });
    }; // переключение изображений между цветами


    var toggleImages = function toggleImages(images, color) {
      var gallery = [];
      ...
      var currentImageSrc = gallery[0].querySelector('.product__image-item-thumb').dataset.image;
    ...
    var setImage = function setImage(image, src) {
      image.src = src;
      image.parentElement.style.backgroundImage = "url(".concat(src, ")");
    };

    var toggleSizeDropdown = function toggleSizeDropdown(selector) {
      selector.addEventListener('click', function () {
        selector.classList.toggle('active');
      });
    };

    var setSize = function setSize(sizes, titleSelector) {
      sizes.forEach(function (size) {
        size.addEventListener('click', function () {
          var currentSize = size.dataset.size;
    ...
    var setDataImage = function setDataImage(src) {
      addToCart.dataset.image = src;
    };

    var setDataArticle = function setDataArticle(id) {
      var productStorage = JSON.parse(localStorage.getItem('product'));
    ...
    var setDataColor = function setDataColor(color) {
      var productStorage = JSON.parse(localStorage.getItem('product'));
      productStorage.color = color;
      productStorage.id = "".concat(productStorage.size, "-").concat(color);
      localStorage.setItem('product', JSON.stringify(productStorage));
      setStorageOnData();
    };

    var setSizeColor = function setSizeColor(size) {
      var productStorage = JSON.parse(localStorage.getItem('product'));
      productStorage.size = size;
      productStorage.id = "".concat(size, "-").concat(productStorage.color);
      localStorage.setItem('product', JSON.stringify(productStorage));
      setStorageOnData();
    };

    var setStorageOnData = function setStorageOnData() {
      var storage = JSON.parse(localStorage.getItem('product'));
      addToCart.dataset.title = "".concat(storage.title, " ").concat(storage.color, " ").concat(storage.size);
    ...
    var checkOptions = function checkOptions() {
      var storage = JSON.parse(localStorage.getItem('product'));
      storage.size === '' && storage.color === '' ? addToCart.setAttribute('disabled', true) : addToCart.removeAttribute('disabled');
    };
    ...
    if (colorList) {
      var colorTitle = document.getElementById('color-title'),
...
/***/ "./themes/wearstore/assets/src/js/module/Tabs.js":
/*!*******************************************************!*\
  !*** ./themes/wearstore/assets/src/js/module/Tabs.js ***!
  \*******************************************************/
...
/***/ "./themes/wearstore/assets/src/js/module/wNumb.min.js":
/*!************************************************************!*\
  !*** ./themes/wearstore/assets/src/js/module/wNumb.min.js ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./themes/wearstore/assets/src/sass/index.scss":
/*!*****************************************************!*\
  !*** ./themes/wearstore/assets/src/sass/index.scss ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ 0:
/*!*****************************************************************************************************!*\
  !*** multi ./themes/wearstore/assets/src/js/index.js ./themes/wearstore/assets/src/sass/index.scss ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\OpenServer\OpenServer\domains\wear.local\themes\wearstore\assets\src\js\index.js */"./themes/wearstore/assets/src/js/index.js");
module.exports = __webpack_require__(/*! C:\OpenServer\OpenServer\domains\wear.local\themes\wearstore\assets\src\sass\index.scss */"./themes/wearstore/assets/src/sass/index.scss");
