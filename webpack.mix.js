...
mix.setPublicPath('./themes/wearstore/assets');
mix.js('./themes/wearstore/assets/src/js/index.js', 'dist/js')
  ...
  .browserSync({
    ...
    notify: false,
    files: [
      "./themes/wearstore/assets/dist/css/*.css",
      "./themes/wearstore/assets/dist/js/*.js",
      "./themes/wearstore/**/*.htm",
    ]
});
